<main>
    ...
    <div class="mx-auto px-6 py-20 md:py-32 max-w-[1400px]">
        <div class="items-center gap-16 grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="relative flex justify-center lg:justify-end pr-0 lg:pr-10">
                <div
            ...
            <div class="mx-auto lg:mx-0 max-w-lg lg:text-left text-center">
                <h2 class="mb-6 font-['Playfair_Display'] font-semibold text-[#4a4a4a] text-3xl md:text-4xl">
    ...
    <div class="mx-auto px-6 pb-24 max-w-[1400px]">
        ...
        <div class="gap-x-6 gap-y-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Rooted in Tradition</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Delve into the deep-seated tradition with our
                    intricately designed fabrics and Maasai Shuka textiles.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Tailored Elegance</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Each garment is a masterpiece, precisely tailored to
                    celebrate your individuality.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <p class="text-[10px] text-gray-500 leading-tight">Discover the meaning behind each pattern, woven with
                    stories from generations past.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Cultural Fusion</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Contemporary meets classic, as Western silhouettes
                    blend with African motifs.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Crafted Diversity</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Our collection showcases the diverse and vibrant
                    spirit of the African continent.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Colorful Narratives</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Don a kaleidoscope of colors, each narrating a unique
                    cultural tale.</p>
            </div>
            ...
            <div class="group cursor-pointer">
                ...
                <h3 class="mb-2 font-bold text-xs uppercase tracking-wide">Sustainable Fashion</h3>
                <p class="text-[10px] text-gray-500 leading-tight">Join us in our journey towards sustainable and
                    ethical fashion practices.</p>
            </div>
